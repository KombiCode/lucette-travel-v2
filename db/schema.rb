...
ActiveRecord::Schema.define(version: 2021_05_20_093754) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.float "latitude"
    t.float "longitude"
    t.index ["latitude", "longitude"], name: "index_bookings_on_latitude_and_longitude"
